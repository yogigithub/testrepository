...
public class StockTradeRecordProcessor implements IRecordProcessor {
     ...
     * {@inheritDoc}
     */
    public StockTradeRecordProcessor(){
    	System.out.println("constructor for StockTradeRecordProcessor");
    }
    @Override
    public void initialize(String shardId) {
    	System.out.println("intialize "+shardId);
    ...
    public void processRecords(List<Record> records, IRecordProcessorCheckpointer checkpointer) {
    	System.out.println("inside processRecords");
    ...
    private void processRecord(Record record) {
    	...
    	System.out.println("Stock Data read is "+trade);
